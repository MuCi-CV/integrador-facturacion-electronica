...
POS_USER_ID_TO_POSALE: dict[int, int | None] = {
...
FOOEVENTS_PAYMENT_METHOD_MAP: dict[str, int] = {
...
DISCOUNT_PRICE_PRODUCT_IDS: frozenset[int] = frozenset({10648, 14369})

# Usan precio plano (item.total sin dividir por cantidad)
FLAT_PRICE_PRODUCT_IDS: frozenset[int] = frozenset({
